...
.container-model .btn-back img {
  width:25px;
  position: absolute;
    top: .5rem;
}
  
.container-model .line {
    display: inline;
    width: 600px;
    height: 2px;
    background: #fff;
