...
<div class="container-mark">
    <div class="content">
        <form class="btn-back" action="" method="GET">
            ...
            <input class="back" type="submit" name="action" value="Sell">
        </form>
        <div class="line"></div>
        <div class="container-step-progress">
            <ul class="progressbar">
                <li data-step="1" class="active">Choose my Mark</li>
                <li data-step="2">Choose my Model</li>
                <li data-step="3">Phone information</li>
            </ul>
        </div>
        <h3>Choose my mark</h3>
        <div class="choose-mark">
            <form method="GET" action="index.php">
                <label for="select">Mark</label>
                <select id="select" name="Mark" required>
